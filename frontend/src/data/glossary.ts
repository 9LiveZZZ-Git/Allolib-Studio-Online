...
texture.submit(img.pixels());`,
  ...
  },
  {
    term: 'culling()',
    category: 'graphics',
    definition: 'Enables or disables face culling.',
    syntax: 'g.culling(true);  // Enable culling\ng.culling(false); // Disable culling',
    platforms: ['both'],
    relatedTerms: ['cullFace'],
  },
  {
    term: 'cullFace()',
    category: 'graphics',
    definition: 'Sets which face to cull when culling is enabled (GL_BACK, GL_FRONT, or GL_FRONT_AND_BACK).',
    syntax: 'g.cullFace(GL_BACK);  // Cull back faces (default)',
    platforms: ['both'],
    relatedTerms: ['culling'],
  },
  {
