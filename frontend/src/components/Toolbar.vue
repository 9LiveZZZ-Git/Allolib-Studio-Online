...
<template>
  <header class="h-12 bg-editor-sidebar border-b border-editor-border flex items-center px-4 gap-4">
      ...
      >
        ...
        <div v-if="activeSettingsTab === 'audio'" class="p-4 space-y-4">
          ...
          <div class="text-xs text-gray-500 bg-editor-sidebar p-2 rounded">
            The safety limiter prevents clipping and protects your speakers. Soft clip adds gentle saturation before hard limiting.
</div>
    ...
    <a
      ...
      class="px-3 py-1.5 hover:bg-editor-active rounded text-sm transition-colors flex items-center gap-1 text-gray-400 hover:text-white"
    >
      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
      </svg>
  ...
  <ExampleDialog
    ...
    @replace-project="handleReplaceProject"
  />
</template>
