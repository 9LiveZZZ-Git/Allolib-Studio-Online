...
<template>
  <div class="h-full flex flex-col bg-editor-bg text-gray-300 text-sm">
    ...
    <!-- Footer -->
    <div class="p-2 border-t border-editor-border text-xs text-gray-500 text-center space-y-1">
      <div>Type <code class="text-yellow-500">help [command]</code> in terminal for detailed info</div>
      <div>
        <a
          href="https://github.com/9LiveZZZ-Git/Allolib-Studio-Online/wiki"
          target="_blank"
          rel="noopener noreferrer"
          title="Documentation &amp; Wiki"
          class="text-gray-400 hover:text-allolib-blue transition-colors inline-flex items-center gap-1"
        >
          View full docs on GitHub Wiki
