/**
 * AlloLib Web - Default Shader Strings for WebGL2/OpenGL ES 3.0
 *
 * This is a patched version of al_DefaultShaderString.cpp that uses
 * GLSL ES 3.0 syntax instead of desktop GLSL 3.30.
 */
...
// WebGL2 / OpenGL ES 3.0 version string
const char* al::shaderVersionString(int major, int minor) {
  // For WebGL2, always use GLSL ES 3.0 with precision qualifiers
  (void)major;
  (void)minor;
