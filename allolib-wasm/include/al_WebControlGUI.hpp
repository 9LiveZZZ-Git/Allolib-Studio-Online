...
// ============================================================================
// C exports for JavaScript interop — definitions live in al_WebControlGUI.cpp.
// (Previously these were inline definitions here intended to override weak
//  stubs in the .cpp; that produced redefinition errors when the .cpp itself
//  included this header — and the inline-vs-weak resolution silently sent
//  the count to 0 anyway. Now the .cpp is the single source of truth.)
// ============================================================================
