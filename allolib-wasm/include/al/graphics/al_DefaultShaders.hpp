...
/**
 * AlloLib Web - Patched Default Shaders for WebGL2/OpenGL ES 3.0
 *
 * This is a modified version of the original al_DefaultShaders.hpp that
 * uses GLSL ES 3.0 syntax (#version 300 es) instead of desktop GLSL 3.30.
 */
...
// WebGL2 / OpenGL ES 3.0 shader version string with precision qualifiers
